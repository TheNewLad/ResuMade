...
/**
 * Custom hook to load a PDF document and render it to a canvas element.
 * Forked from [@mikecousins/react-pdf]{@link https://github.com/mikecousins/react-pdf-js}
 * @TODO Replace with npm package when [#419]{@link https://github.com/mikecousins/react-pdf-js/pull/419} is merged
 */
export const usePdf = ({
  canvasRef,
  file,
